...
function validate() {
	 ...
	 var year = document.createListing.year.value;
	 var mpg = document.createListing.mpg.value;
	 var price = document.createListing.price.value;
	 var priceFormat = /^\d+(?:\.\d+)?(?:,\d+(?:\.\d+)?)*$/gm;
	if(document.createListing.make.value == ""){
		alert("Make Field Cannot Be Empty!");
		return false;
	}
	else if(document.createListing.model.value == ""){
	...
	else if(document.createListing.engine.value == ""){
		alert("Engine Field Cannot Be Empty!");
		return false;
	}
	else if(document.createListing.color.value == ""){
	...
	else if(document.createListing.safteyRating.value == ""){
		alert("Safety Rating Field Cannot Be Empty!");
		return false;
	}
	else if(document.createListing.type.value == ""){
		alert("Type Field Cannot Be Empty!");
		return false;
	}
	else if(document.createListing.transmission.value == ""){
		alert("Please Select Transmission");
		return false;
	}
	else if(document.createListing.fuelType.value == ""){
		alert("Please Select Fuel Type");
		return false;
	}
	else if(document.createListing.drivetrain.value == ""){
...
<form action = "createListingServlet" name = "createListing" method= "post" onsubmit = "return(validate());">
<input type ="hidden" name ="id" value="${id}">
